        ...
        $joursmoisavant++;
            ...
            {   //Si la variable $jour correspond à la date d'aujourd'hui
                ...
                {   //S'il y a un évènement le $jour
                    echo '<td class="aujourdhui"><a href="index.php?eventId='.$evenement[$jour].'" title="voir l’évènement">'.$jour.'</a></td>';
                }
                else
            ...
            else
            {
                if (isset($evenement[$jour]))
                {   //S'il y a un évènement le $jour
                    echo '<td class="jours"><a href="index.php?eventId='.$evenement[$jour].'" title="voir l’évènement">'.$jour.'</a></td>';
                }
                else
                {   //S'il n'y a rien de particulier
